...
class ImageFilesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create image_file" do
    assert_difference('ImageFile.count') do
      post image_files_url, params: { image_file: { description: @image_file.description, owner: @image_file.owner } }
    end
  ...
  test "should update image_file" do
    patch image_file_url(@image_file), params: { image_file: { description: @image_file.description, owner: @image_file.owner } }
